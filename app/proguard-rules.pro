#-libraryjars D:/java/jdk1.7.0_75/jre/lib/rt.jar
#-libraryjars ../bsgamesdk_android_library/libs/android-support-v13.jar
#-libraryjars D:/android-sdk/android-sdk-windows/platforms/android-21/android.jar
...
#-keepparameternames
#-printmapping /Users/bilibili/Development/Android_JAVA/bsgamesdk_android_bilibili_new_out/bilibili_1.5.0.mapping
-dontwarn android.net.**
-keep class android.net.SSLCertificateSocketFactory{*;}
-keepattributes InnerClasses
-keep class com.android.data.sdk.**{ *;}
...
-dontwarn com.bsgamesdk.android.R*

-keep class * extends java.lang.annotation.Annotation

-keeppackagenames com.alipay.**
-keeppackagenames com.tencent.**
-keeppackagenames com.qiniu.**
-keeppackagenames com.bsgamesdk.**
...
-keep class com.bsgamesdk.android.BSGameSdk {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.activity.* {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.widget.* {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.callbacklistener.* {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.api.BSGameSdkAuth {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.api.asynchttp.* {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.utils.LogUtils {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.utils.AESUtil {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.helper.PayRequest {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
...
-keep class com.bsgamesdk.android.dynamic.* {
    public <fields>;
    public <methods>;
    *** set*(***);
    *** get*();
